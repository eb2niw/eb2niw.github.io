<template>
  <div class="container" style="margin-top: 5rem">
    ...
    <div class="row">
      ...
      <div class="col-xl-5 col-lg-4 col-md-6 col-sm-6 col-10 offset-lg-0 offset-sm-3 offset-1">
        <div class="row" style="border-radius: 50%; border: 2px solid; border-color: #ff4e00; margin-top: 2rem">
